...
var style_adm_prov__1 = function(feature, resolution){
    ...
    if (value >= 64.000000 && value <= 77.400000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 77.400000 && value <= 83.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 83.800000 && value <= 89.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 89.200000 && value <= 93.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 93.000000 && value <= 99.000000) {
            style = [ new ol.style.Style({
